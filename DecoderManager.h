...
typedef struct ARCODECS_Manager_FFMPEGDecoder_t ARCODECS_Manager_FFMPEGDecoder_t;
...
ARCODECS_Manager_FFMPEGDecoder_t* FFMPEGManager(ARCODECS_Manager_t *manager);
AVCodecContext* AVContext(ARCODECS_Manager_FFMPEGDecoder_t *FFMPEGmanager);
